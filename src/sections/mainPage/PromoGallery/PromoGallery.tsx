...
const PromoGallery: FC<PromoGalleryProps> = ({}) => {
  return (
    <div className={cn(styles.galleryWrapper)}>
      <UiContainer maxWidth={'1920px'} margin={'0px'}>
        <UiContainer
        ...
        >
          <article className={cn(styles.textBlock)}>
            ...
            <div className={cn(styles.heading)}>
              ...
              <p>
                We have a propspering community and it`s growing faster than
                ever. Suggest new features, discuss what`s new, and or share
                your content
              </p>
            </div>
